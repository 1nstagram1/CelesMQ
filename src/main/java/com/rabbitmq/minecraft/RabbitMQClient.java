...
import com.rabbitmq.minecraft.connection.RabbitMQConnectionManager;
import com.rabbitmq.minecraft.listener.MessageListener;
import com.rabbitmq.minecraft.messaging.RabbitMQConsumer;
import com.rabbitmq.minecraft.messaging.RabbitMQPublisher;
...
/**
 * Main API class for RabbitMQ integration in Minecraft plugins
 * This class provides a simple interface to interact with RabbitMQ
 */
public class RabbitMQClient {
     ...
     */
    public RabbitMQClient(JavaPlugin plugin, RabbitMQConfig config) {
        this.connectionManager = new RabbitMQConnectionManager(plugin, config);

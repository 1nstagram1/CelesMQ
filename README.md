...
[![](https://jitpack.io/v/1nstagram1/RabbitMQ-Lib.svg)](https://jitpack.io/#1nstagram1/RabbitMQ-Lib)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

A comprehensive RabbitMQ integration library for Minecraft plugins (Spigot/Paper) that enables seamless cross-server communication and event handling.

## Features

- Easy-to-use API for RabbitMQ integration
...
<dependencies>
    <dependency>
        ...
        <artifactId>RabbitMQ-Lib</artifactId>
...
dependencies {
    implementation 'com.github.1nstagram1:RabbitMQ-Lib:1.0.0'
}
```
...
```bash
git clone https://github.com/1nstagram1/RabbitMQ-Lib.git
cd RabbitMQ-Lib
mvn clean install
```
...
3. **Sync to main thread for Bukkit API calls**
   ```java
...
5. **Use manual acknowledgment for critical messages**
   ```java
